  ...
  return (
    <Layout>
      <div className="predict-container">
        <h1 className="predict-title">🌿 Plant Health Analyzer</h1>
        ...
        <div className="upload-card">
          ...
          >
            {loading ? (
              <span className="spinner-text">Analyzing Leaf...</span>
            ) : (
              "Diagnose Plant"
            )}
          </button>
        ...
        {result && (
          <div className="result-card">
            ...
            <div className="result-header">
              <div>
                <span className="badge-plant">{result.plant_name}</span>
                <h2 className="disease-title">{result.disease_name}</h2>
              </div>
              <div className="confidence-badge">
                <div className="confidence-score">{result.confidence}%</div>
                <div className="confidence-label">{result.confidence_level} Confidence</div>
              </div>
            </div>

            <div className="severity-bar-container">
              <span className="severity-label">Status: <strong>{result.status}</strong></span>
              <span className="severity-label">Severity: <strong>{result.disease_severity}</strong></span>
            </div>
